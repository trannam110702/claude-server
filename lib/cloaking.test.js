...
test("REQUIRED_OAUTH_BETAS is the full OAuth-path baseline (auth + context + caching)", () => {
  // Sentinel: this is the proxy's authoritative list. Cached upstream betas
  // can ADD flags but never REMOVE any of these. Keep exhaustive on purpose.
