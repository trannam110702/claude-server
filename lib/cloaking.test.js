...
test("REQUIRED_OAUTH_BETAS contains the OAuth-path beta flags Anthropic requires", () => {
  // Sentinel: if Anthropic ever adds another OAuth-only beta we'll need to
  // extend this list. Keep this assertion exhaustive on purpose.
  assert.deepEqual([...REQUIRED_OAUTH_BETAS].sort(), ["claude-code-20250219", "oauth-2025-04-20"]);
});
